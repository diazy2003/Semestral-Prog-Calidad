<html>
<head>
  <title>Formulario de programación enviado</title>
</head>
<body>
  ...
  String insertarsql = "INSERT INTO pr (nombre,cedula,experiencia_virtual) VALUES('" +nombre+ "','" +cedula+ "','" +experiencia_virtual+ "')";
