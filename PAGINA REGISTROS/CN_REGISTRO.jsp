<html>
<head>
  <title>Formulario de Ciencias Naturales enviado</title>
</head>
<body>
  ...
  String insertarsql = "INSERT INTO cn (nombre,cedula,experiencia_virtual) VALUES('" +nombre+ "','" +cedula+ "','" +experiencia_virtual+ "')";
